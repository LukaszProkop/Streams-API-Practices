...
class A_LambdaTest {
    ...
    void a_predicate4() {
        ...
        Predicate<String> startsWithJAndLengthIs7 = str -> str.startsWith("J") && str.length() == 7; // TODO
    ...
    void a_predicate5() {
        ...
        Predicate<String> lengthIs9orError = str -> lengthIs9.test(str) || equalsError.test(str); // TODO
    ...
    @Test
    void b_function1() {
        Function<String, String> func = str -> "(" + str + ")"; // TODO
...
//        Function<String, Integer> lengthBis = str -> length.apply(unNullify.apply(str)); // TODO
        Function<String, Integer> lengthBis = str -> unNullify.andThen(length).apply(str); // TODO
    ...
    @Test
    void c_consumer1() {
        Consumer<StringBuilder> cons = str -> str.append("abc"); // TODO
    ...
    @Test
    void e_bifunction1() {
        BiFunction<String, String, String> bifunc = (str1, str2) -> str1 + str2 + str1; // TODO
    ...
    @Test
    void e_bifunction2() {
        BiFunction<String, String, Integer> bifunc = (str1, str2) -> str1.indexOf(str2); // TODO
