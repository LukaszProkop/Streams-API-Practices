...
import com.java.stream.solutions.learn_solutions.D_SimpleStreams;
...
class D_SimpleStreamsTest {
     ...
     */
    @Test
    void d3_countLinesInFile() throws IOException {
     ...
     */
    @Test
    void d4_findLengthOfLongestLine() throws IOException {
     ...
     */
    @Test
    void d5_findLongestLine() throws IOException {
     ...
     */
    @Test
    void d7_selectByLengthAndPosition() {
        List<String> input = List.of(
                "alfa", "bravo", "charlie", "delta", "echo", "foxtrot", "golf", "hotel");

        List<String> result = input.stream()
                .filter(str -> str.length() > input.indexOf(str))
                .toList(); // TODO
...
// ========================================================
    ...
    void z_setUpBufferedReader() throws IOException {
        reader = new BufferedReader(new InputStreamReader(D_SimpleStreamsTest.class.getResource("/SonnetI.txt").openStream()));
    }
